...
public class MAIN {
	...
	public static void main(String[] args) throws UsuarioExceptionPasswordIncorrecta, MainExceptionSoloCaracteres,
		...
		// CREAMOS AL ADMINISTRADOR, CLIENTE , PRODUCTO Y PEDIDO ACA, PORQUE DENTRO NO NOS DEJABA, PEDIA QUE SEA UNA VARIABLE ESTATICA
		...
		Pedido p11 = new Pedido(null, null);
		Boolean salir = false;
			...
			do {
				...
				case "1":
					...
					try {
						...
						System.out.println("Si es Administrador presione '1'");
						System.out.println("Si es Cliente presione '2'");
						String opcionNuevaNueva = teclado.next();

						switch (opcionNuevaNueva) {
						
						// SI ES ADMINISTRADOR, VERIFICA QUE LO SEA
						
						case "1":

							if (a1 instanceof Administrador) {

								String opcionADM;
								
								do {

									// MENU DE ACCIONES DEL ADMINISTRADOR
									...
									// <-------------------CREA EL RESTAURANTE EL ADMINISTRADOR---------------------->
									...
									case "1":
										...
										do {
											...
											if (opcionADM1 != "1" || opcionADM1 != "2" || opcionADM1 != "3"
													|| opcionADM1 != "4" || opcionADM1 != "5" || opcionADM1 != "6"
													|| opcionADM1 != "7" || opcionADM1 != "8" || opcionADM1 != "9"
													|| opcionADM1 != "10" || opcionADM1 != "11") {
												salir = true;
											}
						...
						case "2":
							if (c1 instanceof Cliente) {
								...
								do {
									...
									case "1":
										Integer mesa;
										System.out.println("Selecciono pedir pedido");
										System.out.println("Ingrese numero de mesa");
										mesa = teclado.nextInt();

										p11.setMesa(mesa);
										p11.setRestaurante(r1);
										System.out.println("Ya podes empezar con tu pedido");
									...
									case "2":
										Integer producto;
										r1.mostrarCarta();
										Boolean errorPedido = true;

										do {
											System.out.println("Ingrese el id del producto que quiera pedir");
											producto = teclado.nextInt();

											try {
												c1.pedirProducto(producto, p11, r1);

											} catch (ExceptionProductoInexistente e) {
												System.out.println(e.getMessage());
											}

										} while (errorPedido != true);

										// <----------------ELIMINAR PRODUCTO DEL PEDIDO------------------->

									case "3":
										Integer productoEliminar;
										r1.mostrarCarta();
										Boolean errorPedido2 = true;

										do {
											System.out.println("Ingrese el id del producto que quiera cancelar");
											productoEliminar = teclado.nextInt();
											try {
												c1.eliminarProducto(p11, productoEliminar);

											} catch (ExceptionProductoInexistente e) {
												System.out.println(e.getMessage());
											}
										} while (errorPedido2 != true);
									...
									case "5":
										System.out.println("Su cuenta es de" + c1.pedirCuenta(p11, r1));
										break;

									// <---------------------- ELIMINAR PEDIDO COMPLETO----------------->

									case "6":
										c1.eliminarPedidoCompleto(p11);
				...
				// REGISTRO DE ADMINISTRADOR O CLIENTE
				case "2":
